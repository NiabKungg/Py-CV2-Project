...
def process_image(image_path="image.jpg"):
    ...
    for (x, y, w, h) in face_detect:
        ...
        cv2.putText(image, 'smile?', (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 1, color, 1)
...
def process_webcam():
    ...
    while True:
        ...
        for (x, y, w, h) in face_detect:
            ...
            cv2.putText(frame, 'smile?', (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 1, color, 1)
...
$$  __$$\               \__|$$ |                $$  __$$\            $$ |                          $$ |    \__|                    
$$ /  \__|$$$$$$\$$$$\  $$\ $$ | $$$$$$\        $$ |  $$ | $$$$$$\ $$$$$$\    $$$$$$\   $$$$$$$\ $$$$$$\   $$\  $$$$$$\  $$$$$$$\  
\$$$$$$\  $$  _$$  _$$\ $$ |$$ |$$  __$$\       $$ |  $$ |$$  __$$\\_$$  _|  $$  __$$\ $$  _____|\_$$  _|  $$ |$$  __$$\ $$  __$$\ 
 \____$$\ $$ / $$ / $$ |$$ |$$ |$$$$$$$$ |      $$ |  $$ |$$$$$$$$ | $$ |    $$$$$$$$ |$$ /        $$ |    $$ |$$ /  $$ |$$ |  $$ |
$$\   $$ |$$ | $$ | $$ |$$ |$$ |$$   ____|      $$ |  $$ |$$   ____| $$ |$$\ $$   ____|$$ |        $$ |$$\ $$ |$$ |  $$ |$$ |  $$ |
\$$$$$$  |$$ | $$ | $$ |$$ |$$ |\$$$$$$$\       $$$$$$$  |\$$$$$$$\  \$$$$  |\$$$$$$$\ \$$$$$$$\   \$$$$  |$$ |\$$$$$$  |$$ |  $$ |
 \______/ \__| \__| \__|\__|\__| \_______|      \_______/  \_______|  \____/  \_______| \_______|   \____/ \__| \______/ \__|  \__|
                                                                                                                 [whit HaarCascade]                                                                                                
