...
def process_image(image_path="image.jpg"):
    ...
    for (x, y, w, h) in face_detect:
        ...
        cv2.putText(image, 'eye', (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 1, color, 1)
...
def process_webcam():
    ...
    while True:
        ...
        for (x, y, w, h) in face_detect:
            ...
            cv2.putText(frame, 'eye', (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 1, color, 1)
...
$$ |     $$ |  $$ |$$   ____| \____$$\       $$ |  $$ |$$   ____| $$ |$$\ $$   ____|$$ |        $$ |$$\ $$ |$$ |  $$ |$$ |  $$ |
$$$$$$$$\\$$$$$$$ |\$$$$$$$\ $$$$$$$  |      $$$$$$$  |\$$$$$$$\  \$$$$  |\$$$$$$$\ \$$$$$$$\   \$$$$  |$$ |\$$$$$$  |$$ |  $$ |
\________|\____$$ | \_______|\_______/       \_______/  \_______|  \____/  \_______| \_______|   \____/ \__| \______/ \__|  \__|
         $$\   $$ |                                                                                                             
         \$$$$$$  |                                                                                           [whit HaarCascade]
          \______/                                                                                                              
