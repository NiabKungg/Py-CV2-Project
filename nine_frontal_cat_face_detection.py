...
def process_image(image_path="image.jpg"):
    ...
    for (x, y, w, h) in face_detect:
        ...
        cv2.putText(image, 'cat face', (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 1, color, 2)
...
def process_webcam():
    ...
    while True:
        ...
        for (x, y, w, h) in face_detect:
            ...
            cv2.putText(frame, 'cat face', (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 1, color, 1)
...
$$  __$$\            $$ |          $$  _____|                                $$  __$$\            $$ |                          $$ |    \__|                    
$$ /  \__| $$$$$$\ $$$$$$\         $$ |   $$$$$$\   $$$$$$$\  $$$$$$\        $$ |  $$ | $$$$$$\ $$$$$$\    $$$$$$\   $$$$$$$\ $$$$$$\   $$\  $$$$$$\  $$$$$$$\  
$$ |       \____$$\\_$$  _|        $$$$$\ \____$$\ $$  _____|$$  __$$\       $$ |  $$ |$$  __$$\\_$$  _|  $$  __$$\ $$  _____|\_$$  _|  $$ |$$  __$$\ $$  __$$\ 
$$ |       $$$$$$$ | $$ |          $$  __|$$$$$$$ |$$ /      $$$$$$$$ |      $$ |  $$ |$$$$$$$$ | $$ |    $$$$$$$$ |$$ /        $$ |    $$ |$$ /  $$ |$$ |  $$ |
$$ |  $$\ $$  __$$ | $$ |$$\       $$ |  $$  __$$ |$$ |      $$   ____|      $$ |  $$ |$$   ____| $$ |$$\ $$   ____|$$ |        $$ |$$\ $$ |$$ |  $$ |$$ |  $$ |
\$$$$$$  |\$$$$$$$ | \$$$$  |      $$ |  \$$$$$$$ |\$$$$$$$\ \$$$$$$$\       $$$$$$$  |\$$$$$$$\  \$$$$  |\$$$$$$$\ \$$$$$$$\   \$$$$  |$$ |\$$$$$$  |$$ |  $$ |
 \______/  \_______|  \____/       \__|   \_______| \_______| \_______|      \_______/  \_______|  \____/  \_______| \_______|   \____/ \__| \______/ \__|  \__|
                                                                                                                                              [whit HaarCascade]                                                                                                
