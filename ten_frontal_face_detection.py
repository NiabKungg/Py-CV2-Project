...
def process_image(image_path="image.jpg"):
    ...
    for (x, y, w, h) in face_detect:
        ...
        cv2.putText(image, 'frontalface', (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 1, color, 1)
...
def process_webcam():
    ...
    while True:
        ...
        for (x, y, w, h) in face_detect:
            ...
            cv2.putText(frame, 'frontalface', (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 1, color, 1)
...
$$  _____|                            $$ |              $$ |      $$  _____|                                $$  __$$\            $$ |                          $$ |    \__|                    
$$ |    $$$$$$\   $$$$$$\  $$$$$$$\ $$$$$$\    $$$$$$\  $$ |      $$ |   $$$$$$\   $$$$$$$\  $$$$$$\        $$ |  $$ | $$$$$$\ $$$$$$\    $$$$$$\   $$$$$$$\ $$$$$$\   $$\  $$$$$$\  $$$$$$$\  
$$$$$\ $$  __$$\ $$  __$$\ $$  __$$\\_$$  _|   \____$$\ $$ |      $$$$$\ \____$$\ $$  _____|$$  __$$\       $$ |  $$ |$$  __$$\\_$$  _|  $$  __$$\ $$  _____|\_$$  _|  $$ |$$  __$$\ $$  __$$\ 
$$  __|$$ |  \__|$$ /  $$ |$$ |  $$ | $$ |     $$$$$$$ |$$ |      $$  __|$$$$$$$ |$$ /      $$$$$$$$ |      $$ |  $$ |$$$$$$$$ | $$ |    $$$$$$$$ |$$ /        $$ |    $$ |$$ /  $$ |$$ |  $$ |
$$ |   $$ |      $$ |  $$ |$$ |  $$ | $$ |$$\ $$  __$$ |$$ |      $$ |  $$  __$$ |$$ |      $$   ____|      $$ |  $$ |$$   ____| $$ |$$\ $$   ____|$$ |        $$ |$$\ $$ |$$ |  $$ |$$ |  $$ |
$$ |   $$ |      \$$$$$$  |$$ |  $$ | \$$$$  |\$$$$$$$ |$$ |      $$ |  \$$$$$$$ |\$$$$$$$\ \$$$$$$$\       $$$$$$$  |\$$$$$$$\  \$$$$  |\$$$$$$$\ \$$$$$$$\   \$$$$  |$$ |\$$$$$$  |$$ |  $$ |
\__|   \__|       \______/ \__|  \__|  \____/  \_______|\__|      \__|   \_______| \_______| \_______|      \_______/  \_______|  \____/  \_______| \_______|   \____/ \__| \______/ \__|  \__|
                                                                                                                                                                            [whit HaarCascade]                                                                                                              
